...
<div ng-controller="SeoController" ng-init="fetchList();">
    ...
    <div class="btn-group btn-group-justified" role="group">
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#NewPresetForm">New Set
            </button>
        </div>
    </div>
    <div>
        <table class="table table-striped table-hover">
            <tr ng-repeat="row in list">
                ...
                <td>{{row.text}}</td>
                <td width="60px">
                    <button type="button" class="btn btn-info" ng-click="linkToProduct(row)">
    ...
    <div class="modal fade" id="EditPresetForm" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form ng-submit="editSet(edit.id, edit.title, edit.description, edit.keywords, edit.h1, edit.snippet, edit.body)">

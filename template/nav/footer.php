...
<div class="padding-top-10 subFooter no-print" style="width: 100%; padding-top: 20px;">
            ...
            <div class="col-12" style="overflow:hidden; padding-top: 15px; margin-top: 15px; border-top: #5a5a5a 1px solid;">
                <div style="float: left;">
                    <script type="text/javascript"> //<![CDATA[
                        ...
                        //]]></script>
                    <script language="JavaScript" async type="text/javascript">
...
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-129783874-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-129783874-1');
</script>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-155076505-1">
</script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}

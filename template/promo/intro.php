<div class="container headPromoBoyGirls">
    <div class="row">
        <div class="col-sm-6 text-center"
             ...
             style="background: #ffffff url(/web/img/child_t20_kRv8Jx.jpg) no-repeat center top/cover; height:400px;">
            <div class="ttl">Одежда для девочек<span>Italian brans</span></div>
        </div>
        <div class="col-sm-6 text-center"
            ...
            <div class="ttl">Одежда для мальчиков<span>Italian brans</span></div>
        </div>
    </div>
</div>
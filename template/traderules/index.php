        ...
        <div class="row">
            <div>
                ...
                <p>
                    ...
                    вернуть изделие в течение 14 дней и Вы получите 100% денег обратно (в том числе и транспортные расходы).
                    Транспортные расходы, связанные с возвратом товара, покрывает потребитель в случае, если он выберет
                    "Бесплатная
                    доставка".
                </p>
                <p>
                    При возврате товара или претензий к нему - в списке заказов требуется нажать "Открыть спор" напротив оспариваемого
                ...
                <p>
                    ...
                    упаковку или в упаковку, эквивалентную оригинальной таким образом, чтобы товар не повредился во время
                    транспортировки.
                </p>
            </div>
        </div>

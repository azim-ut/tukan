    ...
    <div id="content" class="HeadContentPage" ng-init="contents = []">
        <div class="row">
            <div>
                ...
                <p>
                    Неиспользованные товары, которые вам не нравятся, можно вернуть в течение 14 дней в оригинальной
                    упаковке.
                </p>
                <p>
                    Транспортные расходы, связанные с возвратом товара, покрывает потребитель в случае, если при заказе
                    товара он выберет "Бесплатная доставка".
                </p>
                <p>

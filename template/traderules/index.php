    ...
    <div id="content" class="HeadContentPage" ng-init="contents = []">
        <div class="row">
            <div>
                ...
                <p>
                    Если купленный товар по какой-то причине Вам не подходит, то вы можете вернуть изделие в течение 14 дней.
                </p>
                <p>
                    Транспортные расходы, связанные с возвратом товара, оплачивает потребитель.
                </p>
                <p>

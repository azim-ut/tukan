    ...
    <div id="content" class="HeadContentPage" ng-init="contents = []">
        <div class="row">
            <div>
                ...
                <p>
                    Если купленный товар по какой-то причине Вам не подходит, то у потребителя есть возможность
                ...
                <p>
                    При возврате товара - в списке заказов требуется нажать "Открыть спор" напротив оспариваемого
                ...
                <p>
                    ...
                    соображениям здоровья или гигиены, в случае если упаковка распакована после доставки.
                </p>
                <p>
